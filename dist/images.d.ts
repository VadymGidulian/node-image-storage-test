...
declare type Thumbnails = imageUtils.ThumbnailDescription[] | ((metadata: imageUtils.ImageMetadata) => imageUtils.ThumbnailDescription[]);
/**
...
export default class ImageStorage extends TypedEmitter<ImageStorageEvents> {
     ...
     */
    getImagePath(id: string, size?: string, { force }?: {
        force?: boolean;
    }): Promise<string | null>;
    /**
